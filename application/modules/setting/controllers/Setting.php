...
class Setting extends MX_Controller {
	...
	public function update_group($param)
	{
		...
		if($this->Setting_model->update_group($param))
			echo json_encode(array('success'=>true));
		else
        ...
        foreach ($menus as $menu) {
            if ($parent_id == $menu['menu_pid']) {
                ...
                <span class="dd-action">
                  <a href="'.base_url('setting/menu_edit/'.$type.'/edit/'.$menu['menu_id']).'" title="edit"><i class="fa fa-edit" style="color:green"></i></a>
                  <a href="'.base_url('setting/menu_hapus/' . $menu['menu_id']).'" title="Delete" class="delete-confirm" onclick="confirm(\'Yakin ingin menghapus data ini ?\')"><i class="fa fa-trash"></i></a>
              </span></p>';
