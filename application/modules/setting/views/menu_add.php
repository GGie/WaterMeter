...
<!-- Dialog Form -->
    ...
    <div class="easyui-dialog" title="Add Menu" style="width:100%;max-width:400px;padding:10px 60px;">
        <form id="ff" method="post" action="" novalidate>
			<input type="hidden" id="id_menu_type" name="id_menu_type" value="<?php echo $menu_type ?>">
            ...
            <div style="margin-bottom:10px">
                <input type="text" id="url" name="url" class="easyui-textbox" size="25" maxlength="50" value="" placeholder="<?php echo base_url() ?>" data-options="label:'Url:'"/>
            </div>
			...
			<div style="margin-bottom:0px">
				<input type='checkbox' class="easyui-checkbox" name='print' id='print'><label> Print</label>
			</div>
			<div style="margin-bottom:0px">
